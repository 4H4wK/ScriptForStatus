...
#It give you basics informations about your system :
#-Thermals level 
#-Test WIFI connectivity 
#-Display your IP and Gateway 
#-Tell you if the adapter is plugin or not
AND 
#-Count the number of files and directories in the root folder
...
#that works on the cli : If you are running a debian based distro go ahead and type into your console 
- sudo apt-get install acpi
#(you can skip the sudo if you are already root )
#For for RedHat based distro USERS type :
...
#So I've used the file that gets executed when the teminal console is fired up (/root/.bashrc) and where people 
...
=====
    ...
    ./stat.sh
=====
#DONT WORRY ABOUT THE (\e[0--) IT IS JUST FOR COLORING 
#SINCE MY "stat.sh" FILE IS ON THE DESKTOP I ALSO ADDED "cd Desktop"
